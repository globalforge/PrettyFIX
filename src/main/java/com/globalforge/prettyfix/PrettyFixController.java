...
public class PrettyFixController {
        ...
        try {
            ...
            for (FixData fdd : listFdd) {
                ...
                if (group != null) {
                    ...
                    displayString += getDisplayText(fdd, curGroup.size(),
                        sortOption);
                ...
                if (tagNum.equals(group.getDelimiter())) {
                    ...
                    displayString += getDelimiterLine(curGroup.size(),
                        sortOption);
                }
    ...
    private String getDisplayText(FixData fdd, int nestingLevel,
        int sortOption) {
        ...
        displayString += (fdd.getTagName().isEmpty() ? ""
            : (" (" + fdd.getTagName() + ")"));
        displayString += " = " + fdd.getTagVal();
        displayString += (fdd.getTagDef().isEmpty() ? ""
            : (" (" + fdd.getTagDef() + ") "));
        displayString += "\n";
        return displayString;
    }
